...
function UpdateChestEsp() 
        for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
            pcall(function()
                if string.find(v.Name,"Gold Chest") then
                    if ChestESP then
                        if string.find(v.Name,"Gold Chest") then
...
local win = ui:W1n("KaGa HUB","  ONE PIECE OPEN SEAS",0.30,Enum.KeyCode.RightControl)

local Tap = win:Tap("Main")


local AutoFarm = Tap:newpage()
local Setting = Tap:newpage()

AutoFarm:Title("General")
Setting:Title("SettingFarm")


--AutoHaki
Weapon = "Haki: Busoshoku"
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(Weapon))
function AutoHaki()
    pcall(function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Haki: Busoshoku").ActionEvent:FireServer()
end)
end
AutoHaki()	


AutoFarm:Button("Copy Link Youtube",function()
  setclipboard("https://youtube.com/@katap999")
end)

AutoFarm:Button("Copy Link Discord",function()
  setclipboard("https://discord.gg/FtP9hbv7")
end)



AutoFarm:ToggleDesc("AutoFarm Monster","Checking",false,function(Value)
...
AutoFarm:ToggleDesc("AutoFarm Boss","Checking",false,function(Value)
...
AutoFarm:ToggleDesc("BringFruit","Checking",false,function(Value)
_G.Bring_Fruit = Value
while _G.Bring_Fruit do wait()
    for i,v in pairs(game:GetService("Workspace").DevilFruits:GetChildren()) do
        if v:IsA("Tool") then
...
AutoFarm:ToggleDesc("AutoFarm Chest","Checking",false,function(Value)
_G.Farm = Value

while _G.Farm do wait()

for i,v in pairs(game:GetService("Workspace").Chests:GetDescendants()) do
if v.Name == "Gold Chest-to-Gold Chest Strong Joint" and _G.Farm == true and v.Parent.transparency == 0 then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.Parent.CFrame
wait(0.5)
fireclickdetector(v.Parent.Click)
end
end
end
end)
    ...
    spawn(function()
        ...
        while _G.Auto_Farm_Monster == true do wait()
            pcall(function()
                ...
                game:GetService("ReplicatedStorage").DialogEvent:FireServer("finishbanditquest")
            for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
...
game.Players.LocalPlayer.Character[tostring(_G.Weapon)]:Activate()
                until (v:FindFirstChildWhichIsA("Humanoid").Health <= 0 or false or _G.Auto_Farm_Monster == false)
end
end
end
end)
...
local SelectToolWeapona = Setting:Dropdown("Select Weapon",Wapon,function(Value)
_G.Weapon = Value
end)
...
local Mon = Setting:Dropdown("Select Monster",MonName,function(Value)
_G.Monster = Value
end)

local Boss = Setting:Dropdown("Select Boss",BossName,function(Value)
 _G.Boss = Value 
end)
...
local Tap = win:Tap("Players")

local Player = Tap:newpage()
local Esp = Tap:newpage()
...
local X = Player:Dropdown("Select Players",Plr,function(Value)
SPlayer = Value
end)

Player:Button("Refresh Players",function()
pcall(function()
        X:Clear()
wait(0.1)
for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
Player:Button("Teleport Player",function()
  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[SPayer].Character.HumanoidRootPart.CFrame
  end)

Player:ToggleDesc("Loop Teleport","Checking",false,function(t)
_G.TPPlayer = t
...
Esp:ToggleDesc("Esp Players","Checking",false,function(Value)
ESPPlayer = Value
...
Misc:Button("Random Fruit",function()
game:GetService("ReplicatedStorage").DialogEvent:FireServer("buydevilfruit")
 end)

Misc:Button("Remove Fruit",function()
game:GetService("ReplicatedStorage").DialogEvent:FireServer("removedevilfruit")
  end)
